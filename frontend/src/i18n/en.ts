const en = {
  ...
  tenantDashboard: {
    ...
    roommates: {
      ...
      noProfilesFiltered: 'No tenant profiles match these filters.',
      noGroups: 'No groups are available to request joining.',
      compatibility: '{{count}}% compatible',
      filtersTitle: 'Tenant filters',
      clearFilters: 'Clear filters',
      compatibilitySort: 'Compatibility',
      sortDefault: 'Default order',
      sortCompatibilityDesc: 'Highest first',
      sortCompatibilityAsc: 'Lowest first',
      maxBudget: 'Maximum budget',
      preferredArea: 'Preferred area',
      preferredAreaPlaceholder: 'City, town or neighborhood',
      situation: 'Situation',
      ...
      noPreferredArea: 'No preferred area',
      noBudget: 'No budget specified',
      budgetValue: 'Budget up to €{{amount}}',
      filterLabel: 'Show',
      filterAll: 'All',
  ...
  tenantGroups: {
    ...
    card: {
      ...
      approvalProgress: '{{approved}}/{{total}} approvals',
    },
    detail: {
